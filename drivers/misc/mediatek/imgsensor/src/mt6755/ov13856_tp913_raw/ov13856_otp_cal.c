...
//#define OV13856_R2A_write_i2c(addr, para) iWriteReg((u16) addr , (u32) para , 1, OV13856TP913_WRITE_ID)
#define PFX "OV13856_R2A_OTP"
//#define LOG_INF(format, args...)	//xlog_printk(ANDROID_LOG_INFO   , PFX, "[%s] " format, __FUNCTION__, ##args)
#define LOG_INF(format, args...)    pr_debug(PFX "[%s] " format, __FUNCTION__, ##args)

#define Delay(ms)  mdelay(ms)
static unsigned char OV13856TP913_WRITE_ID = 0X00;

kal_uint16 OV13856_R2A_read_i2c(kal_uint32 addr)
{
    kal_uint16 get_byte=0;
    iReadReg((u16) addr ,(u8*)&get_byte,OV13856TP913_WRITE_ID);
    return get_byte;
}

kal_uint16 OV13856_R2A_write_i2c(kal_uint32 addr, kal_uint32 para)
{
		iWriteReg((u16) addr , (u32) para , 1, OV13856TP913_WRITE_ID);
		return 1;
}
#endif
...
void otp_cali(unsigned char writeid)
{
	...
	OV13856TP913_WRITE_ID = writeid;
	LOG_INF("OV13856TP913_WRITE_ID: 0x%x \n", OV13856TP913_WRITE_ID);
