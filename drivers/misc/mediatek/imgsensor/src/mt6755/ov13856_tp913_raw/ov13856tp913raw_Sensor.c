...
static kal_uint8 OV13856TP913_AWB_Data[20];/* [linyimin end] Add awb cali */

static int is_cap2_setting = 0;

extern unsigned char oqc_eeprom_buf[2048];
extern bool read_ov13856_eeprom_OQC(BYTE* data, kal_uint32 size);

static imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV13856_TP913_SENSOR_ID,
    ...
    .isp_driving_current = ISP_DRIVING_4MA, //mclk driving current  // [huangxiancong] Change to 4mA
...
#endif
	{ 4256, 3168, 0,   8, 4256, 3152, 4256, 3152,  16,      8,       4224, 3136, 0,   0,   4224, 3136},//slim-video
...
static void write_shutter(kal_uint16 shutter)
{
	...
	if (is_cap2_setting == 0 && imgsensor.autoflicker_en == KAL_TRUE)
	{
...
else if (currefps == 240)
{
	...
	write_cmos_sensor(0x3002, 0x61);
        ...
        write_cmos_sensor(0x380d, 0x76);//hts=1122
...
{
#if defined(CONFIG_TPLINK_PRODUCT_TP913)
    return ( (read_cmos_sensor(0x300a) << 16) | (read_cmos_sensor(0x300b) << 8) | read_cmos_sensor(0x300c)) + 2;
#else
    return 0xFFFFFFFF;
#endif
        ...
        do {
            *sensor_id = return_sensor_id();
            if (*sensor_id == imgsensor_info.sensor_id) {
                ...
                back_camera_module_current = MODULE_OV13855_TRULY;

                read_ov13856_eeprom_OQC(oqc_eeprom_buf, sizeof(oqc_eeprom_buf));
...
void ov_13856_apply_awb_otp(void)
{
	...
	if (!read_ov13856_eeprom_AWB(0x0020,OV13856TP913_AWB_Data,12))
	{
	...
	rg = (OV13856TP913_AWB_Data[0] << 8) + OV13856TP913_AWB_Data[1];
	bg = (OV13856TP913_AWB_Data[2] << 8) + OV13856TP913_AWB_Data[3];
    ...
    switch (scenario_id) {
        ...
        case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
            if (imgsensor.current_fps == imgsensor_info.cap1.max_framerate) {
                ...
                imgsensor.dummy_line = (frameHeight > imgsensor_info.cap1.framelength)?(frameHeight - imgsensor_info.cap1.framelength):0;
                imgsensor.frame_length =imgsensor_info.cap1.framelength + imgsensor.dummy_line;
                imgsensor.min_frame_length = imgsensor.frame_length;
                spin_unlock(&imgsensor_drv_lock);
            /*}
            else if (imgsensor.current_fps == imgsensor_info.cap2.max_framerate) {
                frameHeight = imgsensor_info.cap2.pclk / framerate * 10 / imgsensor_info.cap2.linelength;
                spin_lock(&imgsensor_drv_lock);

                imgsensor.dummy_line = (frameHeight > imgsensor_info.cap2.framelength)?(frameHeight - imgsensor_info.cap2.framelength):0;
...
UINT32 OV13856_TP913_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
