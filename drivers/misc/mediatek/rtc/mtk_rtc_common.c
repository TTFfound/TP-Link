...
#include <mt-plat/battery_common.h> // [zhangdong] Add shipping mode
...
void mt_power_off(void)
{
	...
	/* [zhangdong start] Added shipping mode */
...
/* [tanghonghui start] For on_boot vibration flag */
...
#endif
	// [tanghonghui start] Add for on_boot vibration
