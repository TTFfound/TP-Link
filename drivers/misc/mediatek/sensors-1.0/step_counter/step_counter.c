...
/* [fengyunliang start]  screen on/off notifier */
...
/* [fengyunliang start] Modify screen off polling */
...
static void step_c_work_func(struct work_struct *work)
{
	...
	/* [fengyunliang] Do not report the value to user when screen off */
	...
	// Fix sensors hidl crash and reboot problem
...
static int step_c_real_enable(int enable)
{
	...
	if (0 == enable) {
		/* [fengyunliang] Reset last_counter_value */
