...
#define DW9714TP913AF_SetI2Cclient DW9714TP913AF_SetI2Cclient_Main
#define DW9714TP913AF_Ioctl DW9714TP913AF_Ioctl_Main
#define DW9714TP913AF_Release DW9714TP913AF_Release_Main
extern int DW9714TP913AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long DW9714TP913AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param);
extern int DW9714TP913AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
