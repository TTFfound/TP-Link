...
/* [zhangdong start] Modify call and sreen state charging current */
#define SCREEN_ON  1
#define SCREEN_OFF 0

#define CALL_ACTIVE_ICHR CHARGE_CURRENT_1000_00_MA
/* [zhangdong end] */
...
extern bool is_set_transport_mode(void);
...
/* [zhangdong] disable high temp protect */
extern int get_Batt_Temp_Protect_Mode(void);
