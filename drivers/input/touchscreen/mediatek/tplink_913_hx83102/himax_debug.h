...
#define HIMAX_PROC_TOUCH_FOLDER		"touchpanel" //[lichenggang start]change android_touch to touchpanel
...
int32_t *diag_mutual_max = NULL;//morgen
int32_t *diag_self_max = NULL;//morgen
bool IS_MAX_RAWDATA = false;//morgen
/* [yanlin end] */
...
/* [lichenggang start]psensor disable tp when incall*/
#ifdef PSENSOR_CONTROL_TP_ENABLE
#define HIMAX_PROC_PSENSOR_DISABLE_TP_FILE "psensor_incall_disable_tp"
struct proc_dir_entry *himax_proc_psensor_disable_tp = NULL;
#endif
/* [lichenggang end] */

/* [lichenggang start] add tp report rate node */
#define HIMAX_PROC_TP_RATE_REPORT_FILE "tp_report_rate"
struct proc_dir_entry *himax_proc_tp_report_rate = NULL;
/* [lichenggang end] */
...
#ifdef HX_HIGH_SENSE
#define HIMAX_PROC_HSEN_FILE "glove_mode_enable"  //[lichenggang start]change HSEN to glove_mode_enable
...
#define HIMAX_PROC_SMWP_FILE "double_tap_enable" //[lichenggang start]change SMWP to double_tap_enable*/
struct proc_dir_entry *himax_proc_SMWP_file = NULL;

/*[lichenggang start] add support_gesture_id node */
#define HIMAX_PROC_SUPPORT_GESTURE_FILE "support_gesture_id"
struct proc_dir_entry *himax_proc_support_gesture_file = NULL;
/* [lichenggang end] */
...
#ifdef HX_SMART_WAKEUP
#define HIMAX_PROC_GESTURE_COORDINATE_FILE "gesture_coordinate"
struct proc_dir_entry *himax_proc_gesture_coordinate_file = NULL;
#endif
/* [lichenggang end] */
