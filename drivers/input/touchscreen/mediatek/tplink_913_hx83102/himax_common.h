...
#endif
#define HIMAX_DRIVER_VER "0.2.4.0_ABCD1234_01"
...
#define HX_GESTURE_TRACK				/*[lichenggang]open gesture track*/

//#define HX_HIGH_SENSE					/*[lichenggang]close glove mode function*/


//#define HX_THRESHOLD_ADJUST_ENABLE		/* [lichenggang] add for sensitivity adjustment */
//#define HX_PALM_REPORT
#define HX_USB_DETECT_GLOBAL			/*[lichenggang]Improve the ability to resist interference */
...
#define PSENSOR_CONTROL_TP_ENABLE   //psensor contorl tp when call
/* [lichenggang end] */
...
enum fix_touch_info
{
    ...
    FIX_HX_X_RES = 720,
    FIX_HX_Y_RES = 1440,
    FIX_HX_MAX_PT = 10,/* [lichenggang]support 10 finger*/
...
struct himax_ts_data
{
    ...
    uint8_t SMWP_enable;
    uint8_t gesture_cust_en[0xFF];/* [lichenggang]modify for gesture ID */
