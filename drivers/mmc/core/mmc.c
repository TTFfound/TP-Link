...
/* [zhaoyue start] Add hwinfo node at /sys/kernel/emmc_info */
...
static struct emmc_hw_info emmc_hw_info_list[] = {
	...
	/* [zhaoyue start] Add hw_info support H9TQ26ADFTBCUR_KUM */
	{"HBG4a2", "H9TQ26ADFTBCUR_KUM", "Hynix", "3G", "32G"},
	/* [zhaoyue start] Add hw_info support KMGD6001BM_B421 */
	{"GD6BMB", "KMGD6001BM_B421", "Samsung", "3G", "32G"},
	/* [zhaoyue end] */
	/* [liguanxiong start] Add hw_info support H9TQ52ACLTMCUR_KUM */
	{"HCG8a4", "H9TQ52ACLTMCUR_KUM", "Hynix", "4G", "64G"},
	/* [liguanxiong end] */
